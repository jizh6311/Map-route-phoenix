defmodule MapRoutePhoenix.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule MapRoutePhoenix.MyChannel do
  ...
  """
  use Phoenix.Presence, otp_app: :map_route_phoenix,
                        pubsub_server: MapRoutePhoenix.PubSub
end
